...
public class SachTrongGioHangDAL {
    public static ArrayList<SachTrongGioHang> show(String maTaiKhoan){
        try{
            ArrayList<SachTrongGioHang> a = Doc_List_Tu_File.Doc_SachTrongGioHang_Tu_File(), b = new ArrayList<SachTrongGioHang>();
    ...
    public static float showthanhTien(String maTaiKhoan){
        try{
            float t=0;
            ArrayList<SachTrongGioHang> a = Doc_List_Tu_File.Doc_SachTrongGioHang_Tu_File(), b = new ArrayList<SachTrongGioHang>();
            for(SachTrongGioHang i:a){
