...
public class AdminUI extends javax.swing.JFrame {
    ...
    public void show_Sach(){
        ...
        tbSach.setModel(SachBLL.show()); // load data to table
        
        renderer.setHorizontalAlignment( JLabel.CENTER );// Căn giữa dữ liệu bảng
        tbSach.setDefaultRenderer(Object.class, renderer);// chỉ căn giữa dữ liệu là String
    ...
    public void show_TacGia(){
        ...
        tbTacGia.setModel(TacGiaBLL.show()); // load data to table
        renderer.setHorizontalAlignment( JLabel.CENTER );// Căn giữa dữ liệu bảng
        tbTacGia.setDefaultRenderer(Object.class, renderer);// chỉ căn giữa dữ liệu là String
     
    }
    
    public void show_NhaXuatBan(){
        model = (DefaultTableModel) tbNXB.getModel();
        tbNXB.setModel(NhaXuatBanBLL.show()); // load data to table
        renderer.setHorizontalAlignment( JLabel.CENTER );// Căn giữa dữ liệu bảng
        tbNXB.setDefaultRenderer(Object.class, renderer);// chỉ căn giữa dữ liệu là String
    }
    
    public void show_TaiKhoanAdmin(){
        tbTaiKhoan1.setModel(TaiKhoanBLL.show1()); // load data to table
        renderer.setHorizontalAlignment( JLabel.CENTER );// Căn giữa dữ liệu bảng
        tbTaiKhoan1.setDefaultRenderer(Object.class, renderer);// chỉ căn giữa dữ liệu là String
    }
    
    public void show_TaiKhoanUser(){
        tbTaiKhoan2.setModel(TaiKhoanBLL.show2()); // load data to table
        renderer.setHorizontalAlignment( JLabel.CENTER );// Căn giữa dữ liệu bảng
        tbTaiKhoan2.setDefaultRenderer(Object.class, renderer);// chỉ căn giữa dữ liệu là String
    }
    
    public void show_HoaDon(){
        tbHoaDon.setModel(HoaDonBLL.show()); // load data to table
        renderer.setHorizontalAlignment( JLabel.CENTER );// Căn giữa dữ liệu bảng
        tbHoaDon.setDefaultRenderer(Object.class, renderer);// chỉ căn giữa dữ liệu là String
    }
    
    public void show_DoanhThu(){
        tbDSDaBan.setModel(HoaDonBLL.show()); // load data to table
        renderer.setHorizontalAlignment( JLabel.CENTER );// Căn giữa dữ liệu bảng
        tbDSDaBan.setDefaultRenderer(Object.class, renderer);// chỉ căn giữa dữ liệu là String
    ...
    public void show_Row_tbSach(){
        ...
        txtNamXB1.setText(String.valueOf(s.getNamXuatBan()));
        txtSoTrang1.setText(String.valueOf(s.getSoTrang()));
        cboMaTG1.setSelectedItem(s.getMaTG());
        cboMaNXB1.setSelectedItem(s.getMaNXB());
        txtDonGia1.setText(String.valueOf(s.getDonGia()));
        txtSoLuongCon1.setText(String.valueOf(s.getSoLuongCon()));
    }
    ...
    private void initComponents() {
        ...
        jLabel23.setText("Tên đang nhập:");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Theo ngày giao dịch", "Theo số lượng", "Theo thành tiền" }));
        ...
        try{
            ...
            if (reply == JOptionPane.YES_OPTION) {
                if(NhaXuatBanDAL.update(NhaXuatBanDAL.show(),setNXB)){
                    JOptionPane.showMessageDialog(AdminTabPane,"Sửa nahf xuất bản thành công!");
                    show_NhaXuatBan();
                }
                else {
    ...
    private void btnSuaTKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaTKActionPerformed
        ...
        try{
            ...
            if(value.equals(confirmValue)){
                ...
                if (reply == JOptionPane.YES_OPTION) {
                    if(TaiKhoanDAL.update(TaiKhoanDAL.showAdmin(),setTK)){
    ...
    private void btnThemtkUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemtkUserActionPerformed
        ...
        try{
            ...
            if(TaiKhoanDAL.insert(TaiKhoanDAL.showUser(),newTK)){
    ...
    private void delTkUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delTkUserActionPerformed
        ...
        try{
            if(tbTaiKhoan2.getSelectedRow() == -1){
                ...
                int reply = JOptionPane.showConfirmDialog(null, "Bạn có chắc chắn muốn xóa?", "Thông báo", JOptionPane.YES_NO_OPTION);
                if (reply == JOptionPane.YES_OPTION) {
                    TaiKhoanDAL.delete(TaiKhoanDAL.showUser(), delTK);
