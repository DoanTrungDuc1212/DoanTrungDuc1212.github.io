...
public class UserUI extends javax.swing.JFrame {
    ...
    public void show_Sach(){
        ...
        tbSachUser.setModel(SachBLL.show()); // load data to table
        
        renderer.setHorizontalAlignment( JLabel.CENTER );// Căn giữa dữ liệu bảng
        tbSachUser.setDefaultRenderer(Object.class, renderer);// chỉ căn giữa dữ liệu là String
    ...
    public void show_GioHang(){
        ...
        tbGioHang.setModel(SachTrongGioHangBLL.show(DangNhapUI.username)); // load data to table
        }
